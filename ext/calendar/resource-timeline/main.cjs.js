...
var timelinePlugin = require('../timeline');
...
var SpreadsheetIndividualCellInner = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetIndividualCellInner, _super);
...
var SpreadsheetIndividualCell = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetIndividualCell, _super);
    ...
    SpreadsheetIndividualCell.prototype.render = function () {
        ...
        return (common.createElement(common.MountHook, { hookProps: hookProps, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, function (rootElRef) { return (common.createElement("td", { ref: rootElRef, "data-resource-id": props.resource.id, className: [
                'fc-datagrid-cell',
                'fc-resource',
            ...
            common.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: props.innerHeight } },
                common.createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
                    colSpec.isMain && (common.createElement(ExpanderIcon, { depth: props.depth, hasChildren: props.hasChildren, isExpanded: props.isExpanded, onExpanderClick: _this.onExpanderClick })),
...
var SpreadsheetGroupCell = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetGroupCell, _super);
...
var SpreadsheetRow = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetRow, _super);
...
var SpreadsheetGroupRow = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetGroupRow, _super);
    ...
    SpreadsheetGroupRow.prototype.render = function () {
        ...
        return (common.createElement("tr", null,
            common.createElement(common.RenderHook, { hookProps: hookProps, classNames: spec.labelClassNames, content: spec.labelContent, defaultContent: renderCellInner, didMount: spec.labelDidMount, willUnmount: spec.labelWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("td", { ref: rootElRef, colSpan: props.spreadsheetColCnt, className: [
                    'fc-datagrid-cell',
                    'fc-resource-group',
...
var SpreadsheetHeader = /** @class */ (function (_super) {
    tslib.__extends(SpreadsheetHeader, _super);
        ...
        rowNodes.push(common.createElement("tr", { key: "row" }, colSpecs.map(function (colSpec, i) {
            ...
            return (common.createElement(common.RenderHook, { key: i, hookProps: hookProps, classNames: colSpec.headerClassNames, content: colSpec.headerContent, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("th", { ref: rootElRef, className: ['fc-datagrid-cell'].concat(classNames).join(' ') },
                common.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                    common.createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
                        colSpec.isMain && (common.createElement("span", { className: "fc-datagrid-expander fc-datagrid-expander-placeholder" },
...
var ResourceTimelineLaneMisc = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineLaneMisc, _super);
...
var ResourceTimelineLane = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineLane, _super);
    function ResourceTimelineLane() {
        ...
        _this.handleHeightChange = function (innerEl, isStable) {
            if (_this.props.onHeightChange) {
                ...
                common.elementClosest(innerEl, 'tr'), isStable);
            }
        };
        return _this;
    }
...
var DividerRow = /** @class */ (function (_super) {
    tslib.__extends(DividerRow, _super);
    function DividerRow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DividerRow.prototype.render = function () {
        ...
        return (common.createElement("tr", { ref: props.elRef },
            common.createElement(common.RenderHook, { hookProps: hookProps, classNames: renderingHooks.laneClassNames, content: renderingHooks.laneContent, didMount: renderingHooks.laneDidMount, willUnmount: renderingHooks.laneWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("td", { ref: rootElRef, className: [
                    'fc-timeline-lane',
                    'fc-resource-group',
...
var ResourceTimelineLanesBody = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineLanesBody, _super);
...
var ResourceTimelineLanes = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineLanes, _super);
    ...
    ResourceTimelineLanes.prototype.updateCoords = function () {
        ...
        if (props.onRowCoords && props.clientWidth !== null) { // a populated clientWidth means sizing has stabilized
            this.props.onRowCoords(new common.PositionCache(this.rootElRef.current, collectRowEls(this.rowElRefs.currentMap, props.rowNodes), false, true));
        }
    };
...
var ResourceTimelineGrid = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineGrid, _super);
    ...
    ResourceTimelineGrid.prototype.render = function () {
        ...
        return (common.createElement("div", { ref: this.handleEl, className: [
                'fc-timeline-body',
            ...
            common.createElement(common.NowTimer, { unit: timerUnit }, function (nowDate, todayRange) { return (common.createElement(common.Fragment, null,
                ...
                common.createElement(timelinePlugin.TimelineLaneBg, { businessHourSegs: hasResourceBusinessHours ? null : bgSlicedProps.businessHourSegs, bgEventSegs: bgSlicedProps.bgEventSegs, timelineCoords: slatCoords, 
                ...
                (context.options.nowIndicator && slatCoords && slatCoords.isDateInRange(nowDate)) && (common.createElement("div", { className: "fc-timeline-now-indicator-container" },
                    common.createElement(common.NowIndicatorRoot, { isAxis: false, date: nowDate }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("div", { ref: rootElRef, className: ['fc-timeline-now-indicator-line'].concat(classNames).join(' '), style: timelinePlugin.coordToCss(slatCoords.dateToCoord(nowDate), context.isRtl) }, innerContent)); }))))); })));
    };
    // Hit System
    // ------------------------------------------------------------------------------------------
...
var ResourceTimelineViewLayout = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineViewLayout, _super);
    function ResourceTimelineViewLayout() {
        ...
        */
        _this.ensureScrollGridResize = function () {
            ...
            }, common.config.SCROLLGRID_RESIZE_INTERVAL + 1);
        };
        return _this;
    }
    ResourceTimelineViewLayout.prototype.render = function () {
        ...
        return (common.createElement(scrollgrid.ScrollGrid, { ref: this.scrollGridRef, elRef: this.rootElRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
...
var ResourceTimelineView = /** @class */ (function (_super) {
    tslib.__extends(ResourceTimelineView, _super);
