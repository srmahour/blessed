        ...
        if (headerRowContent) {
            sections.push({
                ...
                chunks: [
                    {
                        key: 'axis',
                        rowContent: function (arg) { return (common.createElement("tr", null, _this.renderHeadAxis('day', arg.rowSyncHeights[0]))); },
                    },
                    {
                        key: 'cols',
                        elRef: this.headerElRef,
